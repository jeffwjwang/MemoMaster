  ...
  **视觉重构准则：**
  ...
  switch (type) {
    ...
    case '读图':
      ...
      3. **核心要点提炼**：使用 "list" 块，列出图中最重要的 3-5 个核心知识点。
      4. **应用场景建议**：使用 "bento" 块，分析这张图可以应用在什么场合（如：演讲引用、写书创作、方案汇报、教学演示等）。
      5. **应用技巧与注意点**：使用 "step" 块，给出在上述场景中应用此图的专业技巧、讲解逻辑或注意事项。
      6. **高情商分享语**：使用 "quote" 块，提供一段简短、深刻的说明文字，方便用户在分享此图时展现出极高的专业素养和洞察力。
